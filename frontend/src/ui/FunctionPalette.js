...
const GROUPS = [
    ...
    },
    {
        ...
        buttons: [
            ...
            { label: "∛", title: "cube root", insert: "sqrt(,3)", cursor: 5 },
...
function insertAtCursor(template, cursorOffset) {
...
export function FunctionPalette() {
    ...
    return (_jsxs("div", { style: {
            ...
            userSelect: "none",
        }, children: [_jsxs("button", { onMouseDown: e => { e.preventDefault(); setOpen(v => !v); }, style: {
                    width: "100%",
                    padding: "5px 12px",
                    background: "none",
                    border: "none",
                    ...
                    letterSpacing: "0.05em",
                        ...
                        }, children: "\u25B2" }), "FUNCTIONS"] }), open && (_jsx("div", { style: {
                    display: "flex",
                    gap: 14,
                    padding: "8px 12px 10px",
                    overflowX: "auto",
                    alignItems: "flex-start",
                }, children: GROUPS.map(group => (_jsxs("div", { style: { flexShrink: 0 }, children: [_jsx("div", { style: {
                                fontSize: 9,
                                color: "rgba(255,255,255,0.28)",
                                letterSpacing: "0.08em",
                                fontWeight: 600,
                                marginBottom: 5,
                            }, children: group.label.toUpperCase() }), _jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 3 }, children: group.buttons.map(btn => (_jsx("button", { title: btn.title ?? btn.insert, onMouseDown: e => {
                                    e.preventDefault();
                                ...
                                }, style: { ...BTN_BASE }, children: btn.label }, btn.label))) })] }, group.label))) }))] }));
}
